          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex gap-3">
              <Button 
                ...
                disabled={!name.trim()}
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 text-lg font-medium transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                Greet Me! 🎉
              </Button>
            ...
            {greeting && (
              <div className="mt-6 p-6 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg border border-green-200 dark:border-green-700 animate-in fade-in-0 slide-in-from-bottom-4">
